-- FUNCTION: public.agentproductivity_all1(timestamp with time zone, timestamp with time zone)

-- DROP FUNCTION IF EXISTS public.agentproductivity_all1(timestamp with time zone, timestamp with time zone);

CREATE OR REPLACE FUNCTION public.agentproductivity_all1(
...
ALTER FUNCTION public.agentproductivity_all1(timestamp with time zone, timestamp with time zone)
    OWNER TO duo;
